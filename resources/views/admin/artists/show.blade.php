...
@section('content')
  ...
  <div class="top-bar">
    ...
    {{-- Fa vedere i bottoni solo dal proprio profilo artista --}}
    @if (Route::currentRouteName() == 'admin.artists.create')
      <a href="{{ route('admin.artists.edit', $artist) }}" class="btn btn-warning">
    ...
    <div class="artist | p-3 rounded-3 col-12 col-xxl-6">
      ...
      <div class="artist__info">
        ...
        <script>
          ...
          const textLength =
            100; //quando supera 100 caratteri si verifica la condizione e SCATTA la feature
          let isClicked = false;
